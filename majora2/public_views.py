...
def sample_sequence_count_dashboard(request):
    ...
    good_pags = models.PAGQualityReportEquivalenceGroup.objects.filter(test_group__slug="cog-uk-elan-minimal-qc", is_pass=True, is_latest=True, is_suppressed=False)
